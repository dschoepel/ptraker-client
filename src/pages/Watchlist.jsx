...
// Watchlist Page
// =============================================================================
// Track securities of interest — shows live prices from price_cache.
// Tickers are included in the nightly price refresh automatically.
// =============================================================================
...
const AddTickerModal = ({ open, onClose, onAdd, loading }) => {
  ...
  return (
    <Modal
      title={
        <Text style={{ color: "#fff", fontWeight: 600 }}>Add to Watchlist</Text>
      }
      open={open}
      onCancel={onClose}
      onOk={handleOk}
        ...
        <Space direction="vertical" size={0}>
          ...
          {row.asset_name && (
            <Text
              ...
              title={row.asset_name} // show full name on hover
            >
              {row.asset_name}
            </Text>
          )}
          ...
          <Space direction="vertical" size={0} style={{ textAlign: "right" }}>
            ...
            <Space size={4}>
              ...
              <Text
                style={{
                  fontSize: 12,
                  color: gainLossColor(row.change_percent),
                }}
              >
      ...
      {watchlist.length === 0 ? (
        ...
        >
          ...
          <Text style={{ fontSize: 13, color: brandColors.textMuted }}>
            Add tickers manually or they'll be added automatically when you
            sync-delete positions during import
          </Text>
        </div>
      ) : (
        <Table
