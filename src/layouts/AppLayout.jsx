...
import {
  Layout, Menu, Button, Avatar, Dropdown, Typography, Grid, theme,
} from 'antd';
  ...
  const userMenuItems = [
    {
      ...
      disabled: true,
      style: { color: designToken.colorTextSecondary, cursor: 'default' },
    },
    { type: 'divider' },
    {
      key: 'logout',
        ...
        >
          ...
          <Dropdown menu={{ items: userMenuItems }} trigger={['click']} placement="bottomRight">
            <Avatar
              size={32}
              icon={<UserOutlined />}
              style={{ background: brandColors.gold, color: '#000', cursor: 'pointer' }}
            />
          </Dropdown>
        </Header>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: '8px 0',
                  color: isActive ? brandColors.gold : brandColors.textSecondary,
